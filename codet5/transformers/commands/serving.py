...
def serve_command_factory(args: Namespace):
    """
    Factory function used to instantiate serving hmCodeTrans_server from provided command line arguments.
    :return: ServeCommand
    """
    nlp = pipeline(
        task=args.task,
...
class ServeCommand(BaseTransformersCLICommand):
    ...
    def register_subcommand(parser: ArgumentParser):
        ...
        serve_parser.add_argument("--host", type=str, default="localhost", help="Interface the hmCodeTrans_server will listen on.")
